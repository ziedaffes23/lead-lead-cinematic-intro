...
const initial: FormState = { firstName: "", lastName: "", cin: "", lc: "LC Thyna", phoneCountry: "+216", phone: "", email: "", nationality: "Tounsi", track: "", position: "", singleRoom: false, department: "", allergies: "", note: "" };
...
export default function Register() {
  ...
  const validate = (fields: Array<keyof FormState>) => {
    ...
    if (fields.includes("department") && (!form.department || (form.department === "Other" && !otherDepartment.trim()))) next.department = "Select or enter a department.";
  ...
  const submit = async (event: FormEvent) => {
    ...
    const selectedDepartment = form.department === "Other" ? otherDepartment.trim() : form.department;
