...
export default function Register() {
  ...
  const validate = (fields: Array<keyof FormState>) => {
    ...
    if (fields.includes("indemnitySignature") && !form.indemnitySignature.trim()) next.indemnitySignature = "Type your full name as your signature.";
