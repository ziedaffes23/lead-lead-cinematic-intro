...
const initial: FormState = { firstName: "", lastName: "", cin: "", lc: "", phoneCountry: "+216", phone: "", email: "", nationality: "Tunisian", track: "", position: "", singleRoom: false, department: "", allergies: "", note: "" };
...
export default function Register() {
  ...
  const continueToReview = () => { const fields = form.position === "LCP" ? participationFields.filter((field) => field !== "department") : participationFields; if (validate(fields) && validateAttachments()) goTo(3); };
