    ...
    <main className="game-home game-home--single-screen">
      ...
      <section className="world-hero" aria-labelledby="world-title">
        ...
        <div className="world-hero__copy">
          <p className="game-kicker"><span>MISSION 01</span><i /> THE GATHERING</p>
          <h1 id="world-title">LEAD <em>&amp;</em> LEAD <small>2K26</small></h1>
          ...
          <div className="world-hero__actions">
            ...
            <button className="game-secondary" type="button" onClick={() => navigate("/game")}><span>PLAY ROOFTOP TRIAL</span><b>↗</b></button>
          </div>
        </div>

        <aside className="mission-console" aria-label="Mission status">
          <div className="mission-console__top"><span>WORLD HUB</span><b>LIVE</b></div>
        ...
        <div className="world-hero__hud world-hero__hud--left" aria-hidden="true"><span>ROOFTOP ASSEMBLY</span><i /></div>
        <div className="world-hero__hud world-hero__hud--right" aria-hidden="true"><span>BUILD 2K26.09</span><i /></div>
      </section>
